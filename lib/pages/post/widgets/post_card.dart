          ...
          child: Column(
            children: [
              ...
              ClipRRect(
                  borderRadius: BorderRadius.circular(12),
                  child: AspectRatio(
                      aspectRatio: 3 / 2, child: ColoredBox(color: Colors.red))
                  // Image.network(
                  //     'https://img.freepik.com/free-vector/cute-cat-super-hero-cartoon-illustration-animal-hero-concept-isolated-flat-cartoon_138676-2296.jpg?size=338&ext=jpg')
                  ),
              SizedBox(height: 14),
              Row(
